...
theme.loadPlugins = function()
    ...
    NvimTreeFolderIcon = { fg =nord.nord5_gui },
    NvimTreeEmptyFolderName = { fg = nord.nord5_gui },
    NvimTreeOpenedFolderName = { fg = nord.nord5_gui },
    NvimTreeExecFile = { fg = nord.nord5_gui },
    NvimTreeOpenedFile = { fg = nord.nord5_gui },
    NvimTreeSpecialFile = { fg = nord.nord13_gui },
    NvimTreeImageFile = { fg = nord.nord5_gui },
    NvimTreeMarkdownFile = { fg = nord.nord5_gui },
    NvimTreeIndentMarker = { fg = nord.nord4_gui },
