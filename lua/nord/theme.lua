...
theme.loadPlugins = function()
    ...
    NvimTreeSymlink = { fg = nord.nord6_gui },
    NvimTreeFolderName = { fg = nord.nord6_gui },
    NvimTreeFolderIcon = { fg =nord.nord6_gui },
    NvimTreeEmptyFolderName = { fg = nord.nord6_gui },
    NvimTreeOpenedFolderName = { fg = nord.nord6_gui },
    NvimTreeExecFile = { fg = nord.nord6_gui },
    NvimTreeOpenedFile = { fg = nord.nord6_gui },
    NvimTreeSpecialFile = { fg = nord.nord13_gui },
    NvimTreeImageFile = { fg = nord.nord6_gui },
    NvimTreeMarkdownFile = { fg = nord.nord6_gui },
    NvimTreeIndentMarker = { fg = nord.nord5_gui },
		NvimTreeGitDirty = { fg = nord.nord10_gui },
		NvimTreeGitStaged = { fg = nord.nord10_gui },
		NvimTreeGitMerge = { fg = nord.nord10_gui },
