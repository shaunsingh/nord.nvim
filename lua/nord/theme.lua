...
theme.loadPlugins = function()
    ...
    NvimTreeFolderIcon = { fg =nord.nord7_gui },
    NvimTreeEmptyFolderName = { fg = nord.nord7_gui },
    NvimTreeOpenedFolderName = { fg = nord.nord7_gui },
    ...
    NvimTreeIndentMarker = { fg = nord.nord7_gui },
