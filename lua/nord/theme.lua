...
theme.loadPlugins = function()
    ...
    NvimTreeFolderIcon = { fg =nord.nord15_gui },
    NvimTreeEmptyFolderName = { fg = nord.nord8_gui },
    NvimTreeOpenedFolderName = { fg = nord.nord8_gui },
    NvimTreeExecFile = { fg = nord.nord4_gui },
    NvimTreeOpenedFile = { fg = nord.nord4_gui },
    NvimTreeSpecialFile = { fg = nord.nord13_gui },
    NvimTreeImageFile = { fg = nord.nord4_gui },
    NvimTreeMarkdownFile = { fg = nord.nord4_gui },
    NvimTreeIndentMarker = { fg = nord.nord15_gui },
