  ...
  (props, ref) => {
    ...
    const displayValues = React.useMemo(() => {
      ...
      const values = displayKeys.map(
        (key) => keyEntities[key]?.node?.[mergedFieldNames.value] ?? key
      );
    ...
    const triggerChange = useRefFunc(
      (
        ...
        if (onChange) {
          ...
          let returnRawValues: (LabeledValueType | RawValueType)[] =
            eventValues;
        ...
        if (!mergedMultiple) {
          ...
          if (treeConduction) {
            ...
            newRawValues = [
              ...missingRawValues,
              ...checkedKeys.map(
                (key) => keyEntities[key].node[mergedFieldNames.value]
              ),
            ];
          }
          triggerChange(
    ...
    const onDisplayValuesChange = useRefFunc<
      BaseSelectProps["onDisplayValuesChange"]
    >((newValues, info) => {
